# 다산데이타 LISR 스크립트 설치 매뉴얼 2026-06
다산데이타 장비 출고시 설치되는 Ubuntu 26.04 설치 표준안 입니다. 
...
[1. 변수 선언](Ubuntu_26_Install_Guide.md#-1-변수-선언)  

[2. nouveau 끄기 및 grub 설정](Ubuntu_26_Install_Guide.md#-2-nouveau-끄기-및-grub-설정)  

[3. 시스템 설정](Ubuntu_26_Install_Guide.md#-3-시스템-설정)  

[4. 기본 패키지 설치](Ubuntu_26_Install_Guide.md#-4-기본-패키지-설치)  

[5. 프로필 설정](Ubuntu_26_Install_Guide.md#-5-프로필-설정)  

[6. 서버 시간 동기화](Ubuntu_26_Install_Guide.md#-6-서버-시간-동기화)  

[7. 파이썬 설치](Ubuntu_26_Install_Guide.md#-7-파이썬-설치)  

[8. 방화벽 설정](Ubuntu_26_Install_Guide.md#-8-방화벽-설정)  

[9. H/W 사양 체크](Ubuntu_26_Install_Guide.md#-9-HW-사양-체크)  

### ===== GPU 버전 설치 진행 순서 ===== 

[10. CUDA,CUDNN Repo 설치](Ubuntu_26_Install_Guide.md#-10-CUDACUDNN-Repo-설치)

[11. CUDA 설치 및 PATH 설정](Ubuntu_26_Install_Guide.md#-11-CUDA-설치-및-PATH-설정)

[12. CUDNN 설치](Ubuntu_26_Install_Guide.md#-12-CUDNN-설치)

[13. 딥러닝 패키지 설치](Ubuntu_26_Install_Guide.md#-13-딥러닝-패키지-설치)

### =====  Raid manager 설치 진행 순서 ===== 

[14-1. Raid manager MSM 설치](Ubuntu_26_Install_Guide.md#-14-1-MSM-설치)

[14-2. Raid manager LSA 설치](Ubuntu_26_Install_Guide.md#-14-2-LSA-설치)

### ===== Dell 서버 전용 설치 순서 =====

[15. Dell 전용 OMSA설치](Ubuntu_26_Install_Guide.md#-15-Dell-전용-OMSA설치)
***
## # 범례(변수).
...
apt-get -y install  ipmitool python3-pip python3-dev
...
cat > /usr/lib/dracut/modules.d/11systemd-networkd/networkd-config.sh << 'EOF'
#!/bin/sh
# disabled
EOF
